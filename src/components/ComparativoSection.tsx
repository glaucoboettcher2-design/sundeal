    ...
    >
      ...
      <div className="relative z-10 max-w-[1240px] mx-auto">
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-stretch">
          ...
          {/* Card Esquerdo: Tradicional (Amarelo Claro) */}
          <motion.div
          ...
          >
            ...
            <div className="relative px-8 md:px-12 pt-12 pb-8 flex flex-col items-center text-center">
              ...
              >
                <img 
                  src={houseIcon} 
                  alt="Tradicional" 
                  className="w-full h-full object-contain drop-shadow-xl scale-[1.9]"
                />
              </div>
              <h3
              ...
              >
                Instalação
                <br />
                <span style={{ color: "#362200" }}>Tradicional</span>
              </h3>
              
              <div className="flex items-center gap-3 mt-2">
                <div className="h-[1px] w-6" style={{ background: "rgba(0,0,0,0.3)" }} />
                <span
            ...
            >
              <Clock className="w-5 h-5 opacity-80" strokeWidth={2} />
