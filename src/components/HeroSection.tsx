        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-10 lg:gap-16">
          ...
          <div className="flex-1 text-center md:text-left md:mt-10 lg:mt-16">
              ...
              <div className="mb-10 md:mb-0 lg:mb-12 md:flex-1">
                ...
                <p
                  ...
                  style={{
                    ...
                    color: "hsl(0 0% 98%)",
                    filter:
                      "drop-shadow(0 4px 4px rgba(0,0,0,0.4)) drop-shadow(0 2px 2px rgba(0,0,0,0.28))",
                  }}
                >
            ...
            <div
              ...
              style={{ animationDelay: "3.5s", filter: "drop-shadow(0 6px 5px rgba(0,0,0,0.42)) drop-shadow(0 2px 2px rgba(0,0,0,0.3))" }}
            >
              <a
                href="#como-funciona"
